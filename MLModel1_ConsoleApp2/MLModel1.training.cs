...
namespace MLModel1_ConsoleApp2
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\fredr\source\repos\media-organizer\TempConsole\Data\refined_training_data_ner.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.NormalizeText(inputColumnName:@"Sentence",outputColumnName:@"Sentence",caseMode:CaseMode.None,keepDiacritics:false,keepPunctuations:false,keepNumbers:true)      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.NamedEntityRecognition(labelColumnName: @"Label", outputColumnName: @"predicted_label", sentence1ColumnName: @"Sentence", batchSize: 32, maxEpochs: 10))      
                                    .Append(mlContext.Transforms.Conversion.MapKeyToValue(outputColumnName:@"predicted_label",inputColumnName:@"predicted_label"));
