...
public class TvShowEpisodeParserTests
{
    ...
    public void Parse_WithStandardSxxExxFormat_ShouldReturnCorrectEpisodeInfo(string filename, string expectedShow, int expectedSeason, int expectedEpisode, string expectedTitle)
    {
        // Arrange
        ...
        Assert.Equal(expectedTitle, result.EpisodeTitle);
    }
    ...
    public void Parse_WithSeasonXEpisodeFormat_ShouldReturnCorrectEpisodeInfo(string filename, string expectedShow, int expectedSeason, int expectedEpisode, string expectedTitle)
    {
        // Arrange
        var parser = new TvShowEpisodeParser();
    ...
    public void Parse_WithNoEpisodeTitle_ShouldReturnCorrectEpisodeInfo(string filename, string expectedShow, int expectedSeason, int expectedEpisode)
    {
        // Arrange
        var parser = new TvShowEpisodeParser();
        ...
        Assert.Equal(expectedSeason, result.Season);
        Assert.Equal(expectedEpisode, result.Episode);
        Assert.Equal("", result.EpisodeTitle);
    }

    [Theory]
    [InlineData("The Office (2005) S01E01.mkv", "The Office", 1, 1, 2005)]
    [InlineData("Doctor Who (2005) S01E01 Rose.mp4", "Doctor Who", 1, 1, 2005)]
    public void Parse_WithYearInParentheses_ShouldReturnCorrectEpisodeInfo(string filename, string expectedShow, int expectedSeason, int expectedEpisode, int expectedYear)
    {
        // Arrange
        var parser = new TvShowEpisodeParser();
    ...
    public void Parse_WithInvalidFormat_ShouldReturnInvalidEpisodeInfo(string filename)
    {
        // Arrange
        var parser = new TvShowEpisodeParser();
